      ...
      <div className="container">
        ...
        <div className="section-1">
          ...
          <div className="right">
            ...
            <img src="./2.png" alt="logo-2" className="logo-2" />
            <span>
        ...
        <span className="section-2"><p>INSTALLED OVER 10 LAKHS STAR RATED PUMPSETS ACROSS THE COUNTRY RESULTING IN A CUMULATIVE SAVING OF MORE THAN 9,000 MILLION UNITS OF POWER FOR THE NATION.</p></span>
        <div className="section-3">
          <img src="./3.png" alt="logo-3" className="logo-3" />
